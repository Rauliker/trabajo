...
class vender {
    ...
    public function añadir() {
        ...
        $visible = 1;
        $sql = "INSERT INTO vivienda(id, nombre, descrippcion, tipo, provincia, municiopio, direccion, precio, habitaciones, superficie, construccion, estado, visible, enlace) VALUES (NULL, '$name', '$descrip', '$tipo', '$provincia', '$municipios', '$direccion', $prec, $nhab, $superficie, '$construccion', '$estado', $visible, '$enlace');";
        $stmt = $this->db->connection->prepare($sql);
