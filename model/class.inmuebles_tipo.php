...
class InmueblesTipo {
    ...
    public function editar($id) {
        $sql = "SELECT * FROM imuebles_tipo WHERE id = '$id';";
    ...
    public function listar() {
        $sql = "SELECT * FROM imuebles_tipo ORDER BY id ASC;";
    ...
    function insertar($datos){
        ...
        $sql = "INSERT INTO imuebles_tipo (id, nombre, visible) VALUES (NULL, '$nombre', '1');";
    ...
    function modificar($datos, $id){
        ...
        $sql = "UPDATE imuebles_tipo SET nombre = '$nombre' WHERE id = ''$id;";
